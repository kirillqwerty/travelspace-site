...
export default function TourTitleField({ tour, onChange, placeholder }) {
  ...
  return (
    <div className="mt-1 space-y-2">
      <div className="overflow-hidden rounded-lg border border-neutral-200">
        ...
        <Input ref={inputRef} aria-label="Название тура на сайте" value={value}
      ...
      <p className="text-xs text-neutral-500">
        Выделите направление в названии и нажмите «Жирный» или Ctrl+B.
        Повторное нажатие убирает выделение. Жирный текст будет виден в меню
        «Автобусные туры» и «Авиа туры» на компьютере и телефоне.
      </p>
      <div className="rounded-lg border border-neutral-200 bg-neutral-50 px-3 py-2">
        <p className="mb-1 text-xs text-neutral-500">Так название выглядит в меню</p>
        <p className="text-sm font-normal leading-snug text-neutral-700 [overflow-wrap:anywhere]"
          data-testid="tour-title-preview"><TourMenuTitle tour={tour} /></p>
      </div>
    </div>
  );
}
