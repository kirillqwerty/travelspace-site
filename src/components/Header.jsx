...
//               className="hidden 2xl:block border-b border-white/10 overflow-hidden"
...
//           <Link
//             to="/"
//             className="flex items-center gap-2 shrink-0 mr-2 2xl:gap-3 2xl:mr-3"
...
//           {/* DESKTOP NAV */}
//           <nav className="hidden 2xl:flex items-center gap-[clamp(0.35rem,0.8vw,1rem)] text-sm font-medium">
//             <div
//               className="relative"
...
//           {/* RIGHT SIDE */}
//           <div className="hidden 2xl:flex items-center gap-[clamp(0.5rem,1vw,1.5rem)] ml-[clamp(0.5rem,1vw,1.5rem)]">
