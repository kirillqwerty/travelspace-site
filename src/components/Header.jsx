...
//                 scrolled ? "w-7 h-7" : "w-8 h-8 xl:w-9 xl:h-9"
//               }`}
//             />
//             <span
...
//                   aria-label={label}
//                   title={label}
//                   className="size-7 xl:size-8 rounded-full grid place-items-center text-white hover:scale-110 transition"
...
//                     src={logo}
//                     alt=""
//                     className="w-7 h-5 xl:w-8 xl:h-5 2xl:w-9 2xl:h-6 object-contain"
//                   />
//                 ))}
//               </div>
              ...
              <div className="flex items-center gap-0.5 shrink-0">
                {operatorLogos.map((logo, index) => (
                  <img
                    ...
                    src={logo}
                    alt=""
                    className="h-4 w-auto xl:h-5 object-contain"
                  />
                ))}
              </div>
