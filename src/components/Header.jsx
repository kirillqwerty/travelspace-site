...
//     <img src={mediaUrl(item.icon)} alt="" className="h-4 w-4 object-contain" />
//   ) : Icon ? (
...
//   const className =
//     "size-7 xl:size-8 rounded-full grid place-items-center text-white hover:scale-110 transition overflow-hidden border border-white/10";
//   const style = { background: item.color || "#111827" };
...
//             >
//               <div className="mx-auto flex h-9 w-full max-w-none items-center justify-between px-4 text-[11px] text-white/90 xl:px-8 xl:text-[12px] 2xl:max-w-[1440px]">
...
//         {/* MAIN HEADER */}
//         <div
//           className={`mx-auto flex w-full max-w-none items-center justify-between px-4 transition-all duration-500 xl:px-8 2xl:max-w-[1440px] ${
//             scrolled ? "h-14" : "h-16"
//           }`}
//         >
//           <Link
...
//                 scrolled
//                   ? "h-6 w-[150px] xl:w-[170px]"
//                   : "h-7 w-[170px] xl:h-8 xl:w-[190px]"
//               }`}
//             />
//           </Link>

//           {/* DESKTOP NAV */}
//           <nav className="hidden lg:flex items-center gap-1 xl:gap-2 text-[12px] xl:text-[13px] 2xl:text-sm font-medium">
//             <div
//               className="relative"
...
//                 to="/tours"
//                 className={({ isActive }) =>
//                   `flex items-center gap-1 whitespace-nowrap rounded-full px-1 py-1.5 xl:px-1.5 2xl:px-2
...
//                   to={n.to}
//                   className={({ isActive }) =>
//                     `whitespace-nowrap rounded-full px-1 py-1.5 xl:px-1.5 2xl:px-2
//    transition-all duration-200
//    hover:bg-white/15 hover:text-[#F97316]
//    hover:drop-shadow-[0_0_8px_rgba(249,115,22,0.4)]
...
//           {/* RIGHT SIDE */}
//           <div className="hidden lg:flex items-center gap-2 xl:gap-3 2xl:gap-5 ml-2 xl:ml-3">
...
//             </div>
//             <div
//               className={`flex items-center gap-1.5 text-left leading-tight text-[10px] xl:text-[11px] 2xl:text-[12px] min-w-[170px] xl:min-w-[205px] 2xl:min-w-[260px] ${headerMutedText}`}
//             >
...
//               className="hidden xl:inline-flex rounded-full bg-[#C2410C] hover:bg-[#9A3412] text-white font-medium px-4 2xl:px-6"
...
//                         rel="noreferrer"
//                         onClick={closeMenu}
//                         className="flex-1 h-10 rounded-full grid place-items-center text-white shadow-sm active:scale-95 transition overflow-hidden"
//                         style={{ background: item.color || "#111827" }}
//                       >
//                         {item.icon ? (
//                           <img
...
function SocialButton({ item, onMessenger }) {
  ...
  const className =
    "grid size-8 place-items-center overflow-hidden rounded-full text-white transition hover:scale-110 xl:size-9";
...
export default function Header() {
  ...
  "
   ...
   ${isActive ? "text-[#F97316]" : headerMutedText}`
          ...
          {/* RIGHT SIDE */}
          <div className="hidden lg:flex items-center gap-2 xl:gap-2 2xl:gap-3 ml-2 xl:ml-3">
            <div className="flex items-center gap-1">
              {socialButtons.map((item, index) => (
                <SocialButton
                  key={item.id || item.type || item.url || index}
            ...
            <div
              className={`flex min-w-[145px] items-center gap-1.5 text-left leading-none xl:min-w-[155px] 2xl:min-w-[310px] ${headerMutedText}`}
            >
              ...
              <div className="flex min-w-0 flex-col items-start gap-0.5">
                {headerPhones.map((item) => (
                  <a
                    key={item.link || item.phone}
                    href={`tel:${phoneTel(item.link || item.phone)}`}
                    className="flex max-w-full items-baseline gap-1.5 whitespace-nowrap text-[13px] font-bold leading-none transition-colors hover:text-[#F97316] xl:text-[14px] 2xl:text-[15px]"
                  >
                    <span className="shrink-0">{item.phone}</span>

                    <span className="hidden min-w-0 overflow-hidden text-ellipsis text-[11px] font-semibold leading-none opacity-90 2xl:inline-block">
                      · {item.label}
                    </span>
                  </a>
                ))}
            ...
            <Button
              onClick={() => setLeadOpen(true)}
              className="hidden xl:inline-flex shrink-0 rounded-full bg-[#C2410C] px-4 font-medium text-white hover:bg-[#9A3412] 2xl:px-6"
              data-testid="header-pick-tour-btn"
            >
              Подобрать тур
            </Button>
