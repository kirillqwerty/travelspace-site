...
//   const rawMeal = mealPrices[mealPlanKey] || mealPrices.breakfast;
...
//       additional_price:
//         rawMeal.additional_price ?? rawMeal.additionalPrice ?? "",
//       additional_currency:
//         rawMeal.additional_currency ||
//         rawMeal.additionalCurrency ||
//         rawMeal.currency ||
...
//                           <tr>
//                             <th className="border px-2 py-2 text-left">Дата</th>
...
//                         const availableMealPrices = getRoomPricesForDate(
//                           selectedRoom.room,
//                           d,
//                         );
//                         const minPrice = getRoomMinPrice(selectedRoom.room, [
//                           d,
//                         ]);

//                         const openMealStep = () => {
//                           const defaultPlan =
//                             availableMealPrices[0]?.key || "breakfast";
//                           const defaultPrice = getRoomDatePrice(
//                             selectedRoom.room,
//                             d,
//                             defaultPlan,
//                           );
...
//                             prices: availableMealPrices,
//                           });
//                           setSelectedMealPlan(defaultPlan);
//                           setSelectedRoomPrice(defaultPrice);
//                         };
...
//       <Dialog
//         open={!!bookingStep}
//         onOpenChange={(v) => !v && setBookingStep(null)}
//       >
//         <DialogContent
//           className="max-w-md max-h-[calc(100vh-24px)] overflow-y-auto rounded-2xl"
//           onOpenAutoFocus={(event) => event.preventDefault()}
//         >
//           {bookingStep && selectedRoom && (
//             <>
//               <DialogHeader>
//                 <DialogTitle className="font-heading text-2xl">
...
//                   {selectedRoom.room.title || selectedRoom.room.number} ·{" "}
//                   {bookingStep.dateLabel}
//                 </DialogDescription>
//               </DialogHeader>

//               <div className="space-y-2">
//                 {bookingStep.prices.length === 0 && (
//                   <p className="text-sm text-neutral-500">
//                     Для этой даты пока не заполнена стоимость.
//                   </p>
//                 )}

//                 {bookingStep.prices.map((item) => (
//                   <button
//                     key={item.key}
//                     type="button"
//                     onClick={() => {
//                       setSelectedMealPlan(item.key);
//                       setSelectedRoomPrice(item.price);
//                     }}
//                     className={`w-full rounded-xl border px-4 py-3 text-left transition ${selectedMealPlan === item.key ? "border-[#C2410C] bg-orange-50" : "border-neutral-200 bg-white hover:bg-neutral-50"}`}
//                   >
//                     <div className="flex items-center justify-between gap-3">
//                       <span className="font-medium">{item.label}</span>
//                       <span className="font-heading text-xl text-[#C2410C]">
//                         {formatRoomPrice(item.price)}
//                       </span>
//                     </div>
//                   </button>
//                 ))}
