...
// Legacy /directions/:slug URLs map 1-to-1 to the corresponding tour slug
// (or, if no exact match, fall back to the catalog page).
        ...
        <HashRouter>
          <AuthProvider>
            ...
            <Routes>
              ...
              />
              {/* Legacy direction routes redirect to the corresponding tour */}
              <Route
                path="/directions"
              ...
              >
                ...
                />
                {/* Legacy /admin/directions redirects to /admin/tours */}
                <Route
                  path="directions"
